...
// * Strict comparison (e.g., ===) checks for value equality without allowing
// coercion.
// * Abstract comparison (e.g. ==) checks for value equality with coercion
// allowed.
...
// avoid == and use ===.
// If either value in a comparison could be of these specific values (0, "", or []
