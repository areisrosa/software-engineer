...
soma_digitos:
    ...
    push rdx                  ; Guardar o valor original de rdx

    mov  rbx, 10              ; rbx = 10
    mov  rcx, 0               ; rcx = 0

while:
    div  rbx                  ; rdx = rax % rbx, rax //= rbx
    add  rcx, rdx             ; rcx += rdx

    cmp  rax, 0               ; rax > 0 ?
    ja   while                ; Executa do corpo do while novamente caso rax > 0

end:
    mov  rax, rcx             ; rax = rcx

    pop  rdx                  ; Resetaurar o valor original de rdx
