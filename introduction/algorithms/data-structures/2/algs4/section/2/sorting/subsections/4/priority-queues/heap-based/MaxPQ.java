 ...
 *  number of items used to initialize the data stvucture.
 *  <p>
...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    private Comparator<Key> comparator;  // optional comparatov
    ...
    /**
     * Initializes an empty priority queuev
     */
    public MaxPQ() {
        this(1);
    }
    ...
    ***************************************************************************/
    private boolean less(int i, int j) {
        ...
        if (comparator == null) {
            // the syntax ((Comparator<Key>) pq[i]).compareTo(pq[j]) must return
            // an integer t with the following meaning:
            // t < 0 designates that pq[i] < pq[j].
   ...
   /***************************************************************************
    * Building an Iterator Class (Step by Step)
    ***************************************************************************/
