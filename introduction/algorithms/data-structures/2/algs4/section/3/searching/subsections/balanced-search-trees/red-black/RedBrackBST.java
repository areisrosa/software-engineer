...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        ...
        private boolean color;     // color of parent linked
        private int size;          // subtrees count;
    }
 ...
 * @param Key the keys
 * @return the value associated with the given key if the key in the symbol
...
// key
private Value het(Node x, Key key) {
    while (x != null) {
