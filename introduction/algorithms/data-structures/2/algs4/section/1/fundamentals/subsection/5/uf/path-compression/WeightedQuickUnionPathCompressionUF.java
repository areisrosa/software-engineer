 ...
 *  Execution:    java-algs4 Client.java < input.txt
 *
...
public class WeightedQuickUnionPathCompressionUF {
     ...
     *
     * Summary: initializes an empty union-find data structure with n
     ...
     *
     * Summary: returns the component identifier for the component
     * containing site (=object) p
     * Recursiva version
     */
     ...
     *
     * Are the two sites (=objets) p and q in the same component?
     */
    @Deprecated
     ...
     *         both {@code 0 <= p < n} and {@code 0 <= q < n}
     *
     * Summary: merge the component containing site p with the 
    ...
    public void union(int p, int q) {
         ...
         * Consumption of time
         * ---------------------------------------------
         * WeightedQuickUnionPathCompressionUfUF() n
         * union()                                 lg* n
         * find()                                  lg* n
         * Note: lg* amortization, practically constant.
         * ---------------------------------------------
         **********************************************/
}
