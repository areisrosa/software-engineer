 ...
 *  (boolean, byte, char, int, long, float, and double)
 *  to sequences of bits and writing them to an output stream.
 *  The output stream can be standard output, a file, an OutputStream 
 *  or a Socket.
...
public final class BinaryOut {
    ...
    *  Once it is closed, you can no longer write bits.
    */
    public void close() {
        flush();
        try { out.close(); }
