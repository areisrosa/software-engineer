 ...
 *  <br>---<br>
 * Standard random. 
 * Esta classe é uma biblioteca de métodos estáticos 
 * para gerar números pseudoaleatórios 
 * com várias distribuições.
 * Também tem um método para embaralhar os elementos de um vetor.
 * <p>
 * Observação:
 * Depende dos geradores de números pseudoaleatórios da biblioteca
 * java.util.Random.
 * <p>
...
public final class StdRandom {
     ...
     *  Returns real number uniformly distributed in the interval [0, 1).
     */
     ...
     *  Returns an integer uniformly distributed in the set 0 .. N-1.
     *  (Assumes N > 0.) 
     */
     ...
     * Devolve um inteiro com distribuição uniforme 
     * no conjunto a .. b-1.
     * (Supõe b > a >= 0.)
     */
     ...
     * Precondition: array entries are nonnegative 
     * and their sum (very nearly) equals 1.0.
     */
     ...
     * with rate lambda. Assumes lambda > 0.
     */
    ...
    /**
     * Unit test.
     * Takes integer N as command-line argument
     * and, optionally, a seed for the random numbers as a second argument.
     * Prints N batches of numbers;
     * each batch has a random uniform integer form 0..99,
     * a random double from [10.0,99.0),
     * a random boolean from 0..1,
     * a random Gaussian double with mean 9.0 and standard deviation 0.2,
     * and an integer from the set 0..3 
     * with probabilities 0.5, 0.3, 0.1 and 0.1 respectively.
     * Also prints "A", ... , "G". 
     */
