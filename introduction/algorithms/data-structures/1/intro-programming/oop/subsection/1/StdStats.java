 ...
 *  This class provides methods for computing statistics such as 
 *  min, max, mean, sample standard deviation, and  sample variance.<p>
 *  
...
public final class StdStats {
    ...
    /** 
      ...
      * Returns -infinity if no such value.
      */
    ...
    /** Returns the maximum value in the array a[].
     * Returns Integer.MIN_VALUE if no such value.
     */
    ...
    /** 
      * Returns the minimum value in the array a[].
      * Returns Integer.MAX_VALUE if no such value.
      */
    ...
    /** 
     * Plots line segments connecting points (i, a[i]) 
     * to standard draw.
     */
    ...
    /** Plots bars (i, a[i]) to standard draw,
     * for i in 0..N-1, where N is the length of a[].
     */
    ...
    /** Test client.
     *  Reads an array of real numbers from standard input
     *  and prints min, mean, max, and stddev.
     */
