...
/*******************************************************************************
 * Compilation: javac-algs4 WeightedQuickUnionUF.java
 * Execution: java-algs4 WeightedQuickUnionUF < input.txt
 *
...
public class WeightedQuickUnionUF {
    ...
    private int[] size;     // size[i] = number os elements in subtree rooted at i
     ...
     *
     * @return the number of sets (betwenn {@code 1} and {@code n})
     */
    public int count() {
        return count;
    }
    ...
    // validade the p is a valid index
